...
function time_before_js_to_string( $constant_name ){
  $c = @constant( $constant_name );
  if( !is_null( $c ) )
    echo 'var '.$constant_name.' = '.json_encode( $c ).';';
}

function time_before_js(){
  echo '<script>';
  $templates = array(
    'TIMEBEFORE_NOW' ,
    'TIMEBEFORE_MINUTE' ,
